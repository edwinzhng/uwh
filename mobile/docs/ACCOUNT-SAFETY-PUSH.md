...
Deletion removes credentials, sessions, refresh tokens, owned photos, private calendar links, device registrations, the personal profile, attendance, financial/registration/tracker records and private coaching notes. Authored messages become empty anonymous tombstones. Published coaching feedback to other people remains with an anonymous author. Linked children's club profiles remain because they are separate people. Reports have identifying account links removed and expire after 90 days; evidence of the deleted user's own message is cleared immediately. Other people's prose may still mention a former member and requires a separate review if removal is requested. The club should confirm this policy before launch.
