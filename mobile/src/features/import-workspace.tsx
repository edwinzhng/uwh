...
export const ImportWorkspace = (): ReactElement => {
	...
	return (
		<Stack gap="lg">
			<Surface>
				<Stack>
					<Text variant="h4">Import CSV</Text>
					<Text variant="small" tone="secondary">
						Import members, then events, registration and payments. Use the same
						source and IDs when retrying. Up to 500 rows per file.
					</Text>
					<Select
						label="Import"
						value={kind}
							...
							{importFields[kind].map((field) => (
								<Select
									...
									options={[
										{
											value: "none",
											label: field.required ? "Choose column" : "Not included",
										},
			...
			<Surface>
				<Stack>
					<Text variant="h4">Import history</Text>
					<DataPage
						config={{
